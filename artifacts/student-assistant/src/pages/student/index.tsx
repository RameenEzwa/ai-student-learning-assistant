...
import { Send, User as UserIcon, Bot, BrainCircuit, AlertCircle, Sparkles } from "lucide-react";
                ...
                {isEmpty && (
                  <div className="flex flex-col items-center justify-center h-64 text-center px-4">
                    ...
                    <p className="text-muted-foreground max-w-md">
                      I'm your personal AI tutor. Ask me to explain concepts, help with homework, or quiz you on a topic.
                    </p>
                  </div>
                )}
        ...
        <div className="flex flex-col gap-6 overflow-hidden">
          <Card className="flex-1 flex flex-col overflow-hidden border-border shadow-sm rounded-xl">
            <CardHeader className="border-b px-6 py-5 bg-card">
              <CardTitle className="text-xl font-bold">Your Assignments</CardTitle>
              <CardDescription className="text-sm">Quizzes to test your knowledge</CardDescription>
            </CardHeader>
                    ...
                    <Card key={quiz.id} className="cursor-pointer border-border hover:border-primary/50 hover:shadow-md transition-all rounded-xl overflow-hidden group bg-card" onClick={() => {
                      ...
                      <CardHeader className="p-5 pb-3">
                        <div className="flex justify-between items-start gap-4 mb-1">
                          <CardTitle className="text-[17px] font-semibold leading-tight group-hover:text-primary transition-colors">{quiz.title}</CardTitle>
